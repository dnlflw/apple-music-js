         ...
         <Container
            ...
            <InfoContainer isFullscreen={isFullscreen}>
               ...
               <ButtonContainer size={32}>
                  {!(hasAudio && isPlaying) && (
                     <ControlButton onClick={this.resume} aria-label="Play">
                        <ControlIcon src={`${path}/play.svg`} alt="" />
                     </ControlButton>
                  )}
                  {isPlaying && (
                     <ControlButton onClick={this.pause} aria-label="Pause">
                        <ControlIcon src={`${path}/pause.svg`} alt="" />
                     </ControlButton>
                  )}
                  <ControlButton onClick={this.nextSong} aria-label="Next Song">
                     <ControlIcon src={`${path}/skip_next.svg`} alt="" />
                  </ControlButton>
               </ButtonContainer>
            </InfoContainer>
         </Container>
